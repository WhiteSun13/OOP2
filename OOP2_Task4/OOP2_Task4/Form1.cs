    ...
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.RowCount; i++)
            {
                ...
                {
                    dataGridView1.Rows[i].Cells[ii].Value = Convert.ToDouble(rnd.Next(-10000, 10000)) / 100;
                }
            }
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView2.RowCount; i++)
            {
                ...
                {
                    dataGridView2.Rows[i].Cells[ii].Value = Convert.ToDouble(rnd.Next(-10000, 10000)) / 100;
                }
            }
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            catch (IndexOutOfRangeException ex) { MessageBox.Show("Ошибка: " + ex.Message); }
        }
